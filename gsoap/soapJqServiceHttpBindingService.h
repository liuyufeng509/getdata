/* soapJqServiceHttpBindingService.h
...
#ifndef soapJqServiceHttpBindingService_H
#define soapJqServiceHttpBindingService_H
#include "soapH.h"

    class SOAP_CMAC JqServiceHttpBindingService : public soap {
      public:
        /// Variables globally declared in getdata.h, if any
        /// Construct a service with new managing context
        JqServiceHttpBindingService();
        /// Copy constructor
        JqServiceHttpBindingService(const JqServiceHttpBindingService&);
        /// Construct service given a managing context
        JqServiceHttpBindingService(const struct soap&);
        /// Constructor taking input+output mode flags for the new managing context
        JqServiceHttpBindingService(soap_mode iomode);
        /// Constructor taking input and output mode flags for the new managing context
        JqServiceHttpBindingService(soap_mode imode, soap_mode omode);
        ...
        virtual void JqServiceHttpBindingService_init(soap_mode imode, soap_mode omode);
        /// Return a copy that has a new managing context with the same engine state
        virtual JqServiceHttpBindingService *copy() SOAP_PURE_VIRTUAL;
        /// Copy assignment
        JqServiceHttpBindingService& operator=(const JqServiceHttpBindingService&);
        ...
        virtual int getData(ns1__getData *ns1__getData_, ns1__getDataResponse &ns1__getDataResponse_) SOAP_PURE_VIRTUAL;
    };
#endif
